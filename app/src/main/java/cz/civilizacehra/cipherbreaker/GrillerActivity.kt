...
class GrillerActivity : Activity() {
    ...
    private fun reloadGrille() {
        ...
        for (i in 0 until size) {
            ...
            for (j in 0 until size) {
                // TODO special handling for middle cell in odd size
                val cell = grille!![i][j]
                ...
                cell.textSize = dimensions / 4.toFloat()
                ...
                cell.addTextChangedListener(object : TextWatcher {
                    ...
                    override fun onTextChanged(s: CharSequence, start: Int, before: Int, count: Int) {
                        // TODO better behaviour for text input. Handle next/done, backspace.
                        computeGrid()
                        if (s.length == 1) {
                            val nextJ = (j + 1) % size
                            ...
                            if (nextI == size) {
                                ...
                                grille!![nextI][nextJ].requestFocus()
                            }
                        }
                    }
                })
